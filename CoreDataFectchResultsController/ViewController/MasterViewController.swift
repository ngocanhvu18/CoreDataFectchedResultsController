...
class MasterViewController: UITableViewController {
    ...
    var fetchResult = DataService.share.fetchResultController
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let entity = fetchResult.object(at: indexPath)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let detailController = segue.destination as? DetailViewController {
            if let indexPath = tableView.indexPathForSelectedRow {
                detailController.entity = fetchResult.object(at: indexPath)
...
extension MasterViewController: NSFetchedResultsControllerDelegate {
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        case .update:
            configureCell(tableView.cellForRow(at: indexPath!)!, withEntity: anObject as! Entity)
        case .move:
            configureCell(tableView.cellForRow(at: indexPath!)!, withEntity: anObject as! Entity)
